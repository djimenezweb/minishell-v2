...
SRC	=	ft_atod.c ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c \
		...
		ft_memset.c ft_printf.c ft_putchar_fd.c ft_putchar_r.c \
		ft_putendl_fd.c ft_puthex_utils.c ft_putnbr_fd.c ft_putnbr_r.c \
		ft_putnbr_u_r.c ft_putstr_fd.c ft_putstr_r.c ft_split.c ft_strchr.c \
