...
/* Check if a string is correctly quoted 
 * and if there are pipes just followed by other pipes. 
 * Find opening and closing quotation pairs. 
 * Return `1` if it's valid, `0` if it's not */
int	pipes_and_quotes_validation(char *str)
{
	int		i;
	char	pipe;
	char	quote;
